export default [
  ...
  [
    ...
    ['de jeunes enfants, qui s’en seraient servi comme une balle de jeu !', 5000],
    ['Un abbé, passant par là, se serait mêlé à leur récréation.', 9000],
    ['', 13000]
  ],
  [
	  ['Il en aurait même profité pour s’emparer de la tête, une fois ses jeunes amis lassés de la relique.', 0],
    ['Le vol commis par l’abbé Baschamp est envisageable, mais, rassurez-vous,', 5500],
    ['le récit du crâne devenu balle de jeu tient davantage de la légende !', 10000],
    ['Pourtant, cette légende fut racontée tant de fois que beaucoup y crurent pendant des années !', 14500],
	  ['', 19500]
  ],
  [
  ...
  [
    ...
    ['Allons-nous suivre les péripéties du crâne de ville en ville ?', 3200],
    ['Une fois en possession du bonnetier Cheval, la relique sembla disparaître totalement.', 7200],
    ['Beaucoup la pensaient perdue, d’autres la disaient détruite.', 12000],
    ['Mais en réalité, le crâne voyagea bien loin de Paris et de la Sorbonne.', 16200],
    ['Il alla même jusqu’en Bretagne !', 21800],
	  ['', 24500]
  ],
  [
    ...
    ['Transmis de génération en génération,', 9500],
  ...
  [
    ...
    ['la relique était exhibée à la vue du public une fois chaque année…', 5500],
    ['Cet affront finit par atteindre les oreilles de l’Empereur Napoléon III.', 9300],
    ['Il ordonna le retour du crâne en son lieu de repos originel, en 1866.', 13000],
    ['Voilà que l’Empereur s’en mêle…', 18000],
    ['le défunt semble être d’une importance bien particulière...', 19700],
	  ['', 24000]
  ],
  [
  ...
  [
    ...
    ['Le groupe de curieux avait pour objectif de photographier la relique,', 38300],
    ['et d’en faire des moulages…', 41600],
    ['Une fois leur entreprise terminée,', 44300],
    ['le tombeau fut enfin refermé, pour ne plus jamais être dérangé.', 46400],
	  ['', 52500]
  ]
]
