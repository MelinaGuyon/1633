...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '2f200', type: 'i', x: 35, y: 180, scale: 0.64 })) // tete
    ...
    this.mains.push(this.addComponent(Building, { layer: '2f100', type: 'z', x: -168, y: -320, scale: 0.66 })) // baschamp
    this.mains.push(this.addComponent(Building, { layer: '2bg200', type: 'y', x: -700, y: -160, scale: 0.66 })) // joueur centre
    this.mains.push(this.addComponent(Building, { layer: '2f200', type: 'x', x: -230, y: -50, scale: 0.66 })) // joueur left
    this.mains.push(this.addComponent(Building, { layer: '2f200', type: 'w', x: -60, y: -220, scale: 0.66 })) // joueur right
    this.mains.push(this.addComponent(Building, { layer: '2f100', type: 'v', x: -480, y: -150, scale: 0.66 })) // femme gauche
  }
