...
export default class CityBuildings extends PixiComponent {
  setup () {
    this.mains = []
    this.mains.push(this.addComponent(Building, { layer: '2bg800', type: 'c', x: -450, y: -300, scale: 0.66 })) // fond incrusté
    this.mains.push(this.addComponent(Building, { layer: '2bg700', type: 'b', x: -465, y: -320, scale: 0.66 })) // fond
    this.mains.push(this.addComponent(Building, { layer: '2bg690', type: 'a', x: -450, y: -300, scale: 0.66 })) // big
