...
export default class Animations extends PixiComponent {
  setup () {
    ...
    this.refs.drap = this.addChild('draps', { layer: '2bg600', x: -370, y: -210 })
    ...
    this.refs.lampe = this.addChild('lampeBaschamp', { layer: '2bg600', x: -50, y: -245 })
    this.refs.lampe.scale.x = 0.59
    this.refs.lampe.scale.y = 0.59
    this.animLampe = new Animator(this.refs.lampe)
    this.animLampe.play('lampeBaschamp', { loop: true, frameDuration: 200 })
  }
