...
export default class CityBuildings extends PixiComponent {
  setup () {
    this.mains = []
    this.mains.push(this.addComponent(Building, { layer: '5bg800', type: 'd', x: 0, y: -40, scale: 0.64 })) // fond incrusté
    this.mains.push(this.addComponent(Building, { layer: '5bg700', type: 'c', x: -25, y: -60, scale: 0.64 })) // fond
    this.mains.push(this.addComponent(Building, { layer: '5bg690', type: 'b', x: -15, y: -60, scale: 0.64 })) // fond
    this.mains.push(this.addComponent(Building, { layer: '5bg680', type: 'a', x: 0, y: -40, scale: 0.64 })) // big
    ...
    this.mains.push(this.addComponent(Building, { layer: '5bg400', type: 'h', x: -700, y: -400, scale: 0.64 })) // muraille
    this.mains.push(this.addComponent(Building, { layer: '5bg300', type: 'i', x: -600, y: -400, scale: 0.64 })) // arbre
