...
export default class Interests extends PixiComponent {
  setup () {
    ...
    this.mains = []
    this.mains.push(this.addComponent(Colliders, { layer: '11bg200', levelId: 11, x: 100, y: -100, group: 'interests', collide: true, tint: 0xFF0000, cb: this.cb.bind(this, (store.chronologieIdsTable.get()[10])) }))
