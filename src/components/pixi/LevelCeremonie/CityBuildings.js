...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '8bg400', type: 'l', x: 450, y: -70, scale: 0.66 })) // roi
    ...
    this.mains.push(this.addComponent(Building, { layer: '8f200', type: 'o', x: -445, y: 90, scale: 0.66 })) // femme gauche
