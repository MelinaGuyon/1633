...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '8bg690', type: 'c', x: -620, y: -460, scale: 0.68 })) // fond incrusté
    ...
    this.mains.push(this.addComponent(Building, { layer: '8bg500', type: 'i', x: -260, y: -290, scale: 0.66 })) // mec sceptre
    this.mains.push(this.addComponent(Building, { layer: '8bg500', type: 'j', x: -400, y: -250, scale: 0.66 })) // mec livre
    this.mains.push(this.addComponent(Building, { layer: '8bg500', type: 'k', x: -140, y: -270, scale: 0.66 })) // mec porte tete
