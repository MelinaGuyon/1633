...
export default class SoundChecks extends SoundChecksAbs {
  setup () {
    ...
    this.mains.push(this.addComponent(Colliders, { layer: '1bg10', x: -550, y: -100, group: 'sound', collide: true, tint: 0x000000, cb: this.cb.bind(this, 'voixoff/chap_1', 4), name: 'voixoff/chap_1' }))
    ...
    // this.mains.push(this.addComponent(Colliders, { layer: '1bg10', x: 600, y: -100, group: 'sound', collide: true, tint: 0x000000, cb: this.cb.bind(this, 'voixoff/chap_1', 4), name: 'voixoff/chap_1' }))
