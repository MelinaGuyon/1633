...
export default class Interests extends PixiComponent {
  setup () {
    ...
    this.mains = []
    this.mains.push(this.addComponent(Colliders, { layer: '1bg600', levelId: 1, x: 100, y: -100, group: 'interests', collide: true, tint: 0xFF0000, cb: this.cb.bind(this, 0) }))
    // this.mains.push(this.addComponent(Colliders, { layer: '2bg600', x: 400, y: -100, group: 'interests', collide: true, tint: 0xFF0000, cb: this.cb.bind(this, 1) }))
