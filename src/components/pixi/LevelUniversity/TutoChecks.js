...
export default class TutoCheck extends PixiComponent {
  setup () {
    this.mains = []
    //this.mains.push(this.addComponent(Colliders, { layer: '1bg10', x: -1800, y: -100, group: 'tuto', collide: true, tint: 0x3366ff, cb: this.cb.bind(this, 'keyboard'), name: 'keyboard' }))
