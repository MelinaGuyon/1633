...
export default class CityBuildings extends PixiComponent {
  setup () {
    this.mains = []
    this.mains.push(this.addComponent(Building, { layer: '1bg200', type: 'a',   x: 0, y: -150 })) // big
    this.mains.push(this.addComponent(Building, { layer: '1bg100', x: 0, y: -162,   tint: 0x77ddff })) // small
