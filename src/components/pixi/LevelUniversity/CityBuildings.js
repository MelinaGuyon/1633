...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '1bg400', type: 'g', x: 440, y: -10, scale: 0.66 })) //  mec droite
    this.mains.push(this.addComponent(Building, { layer: '1bg100', type: 'i', x: -570, y: -280, scale: 0.66 })) //  mec gauche
