...
export default class SoundChecks extends SoundChecksAbs {
  setup () {
    ...
    this.mains.push(this.addComponent(Colliders, { layer: '6bg200', x: -800, y: -100, group: 'sound', collide: true, tint: 0x000000, cb: this.cb.bind(this, 'voixoff/chap_4_bis', 9), name: 'voixoff/chap_4_bis' }))
	  ...
	  this.mains.push(this.addComponent(Colliders, { layer: '6bg200', x: 600, y: -100, group: 'sound', collide: true, tint: 0x000000, cb: this.cb.bind(this, 'effect/cat', 9), name: 'effect/cat' }))
    // this.mains.push(this.addComponent(Colliders, { layer: '6bg200', x: 700, y: -100, group: 'sound', collide: true, tint: 0x000000, cb: this.cb.bind(this, 'voixoff/chap_4_bis', 9), name: 'voixoff/chap_4_bis' }))
  }
