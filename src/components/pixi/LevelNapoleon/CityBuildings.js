...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '6bg500', type: 'f', x: -700, y: -390, scale: 0.64 })) // bureau
    ...
    this.mains.push(this.addComponent(Building, { layer: '6bg400', type: 'k', x: -196, y: -116, scale: 0.64 })) // armez
  }
