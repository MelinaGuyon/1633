...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '6bg400', type: 'k', x: -80, y: 40, scale: 0.64 })) // armez
    this.mains.push(this.addComponent(Building, { layer: '6bg600', type: 'i', x: 50, y: -220, scale: 0.58 })) // lampe
    this.mains.push(this.addComponent(Building, { layer: '6f100', type: 'h', x: 305, y: 50, scale: 0.64 })) // petit fils
  }
