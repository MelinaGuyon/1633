...
export default class SoundChecks extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Colliders, { layer: '7bg200', x: -500, y: -100, group: 'sound', collide: true, tint: 0x000000, cb: this.cb.bind(this, 'voixoff/chap_4_ter', 1, 0), name: 'voixoff/chap_4_ter' }))
  }
