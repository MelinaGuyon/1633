...
export default class CityBuildings extends PixiComponent {
  setup () {
    this.mains = []
    this.mains.push(this.addComponent(Building, { layer: '3bg700', type: 'c', x: 0, y: -50, scale: 0.66 })) // fond incrusté
    this.mains.push(this.addComponent(Building, { layer: '3bg700', type: 'b', x: -15, y: -70, scale: 0.66 })) // fond
    this.mains.push(this.addComponent(Building, { layer: '3bg700', type: 'a', x: 0, y: -50, scale: 0.66 })) // big
    ...
    this.mains.push(this.addComponent(Building, { layer: '3bg600', type: 'h', x: 65, y: -50, scale: 0.66 })) // bacshamp
    this.mains.push(this.addComponent(Building, { layer: '3bg600', type: 'i', x: -100, y: 150, scale: 0.66 })) // tete
    this.mains.push(this.addComponent(Building, { layer: '3bg600', type: 'j', x: -300, y: 90, scale: 0.66 })) // chien
