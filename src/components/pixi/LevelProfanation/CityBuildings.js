...
export default class CityBuildings extends PixiComponent {
  setup () {
    this.mains = []
    this.mains.push(this.addComponent(Building, { layer: '3bg800', type: 'c', x: -400, y: -300, scale: 0.66 })) // fond incrusté
    this.mains.push(this.addComponent(Building, { layer: '3bg700', type: 'b', x: -415, y: -320, scale: 0.66 })) // fond
    this.mains.push(this.addComponent(Building, { layer: '3bg690', type: 'a', x: -400, y: -300, scale: 0.66 })) // big
