...
export default class CityBuildings extends PixiComponent {
  setup () {
    ...
    this.mains.push(this.addComponent(Building, { layer: '3bg600', type: 'h', x: 65, y: -60, scale: 0.66 })) // bacshamp
    this.mains.push(this.addComponent(Building, { layer: '3f100', type: 'i', x: -50, y: 170, scale: 0.66 })) // tete
